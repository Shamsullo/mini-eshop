...
# for simplicity for now product can be only in one category
...
class Order(models.Model):
	...
	# for simplisity every products need to be shiped
	@property
	def shipping(self):
		# the logic that the sheeping needed or not will written here
		return True
